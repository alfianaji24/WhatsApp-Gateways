    ...
    function () {
        Route::middleware('checkApiKey')->group(function () {
            ...
            Route::match(
                ['post', 'get'],
                '/send-vcard',
                [ApiController::class, 'messageVcard']
            );
            Route::match(['post', 'get'], '/check-number', [ApiController::class, 'checkNumber']);
            Route::post('/logout-device', [DeviceController::class, 'logoutDevice']);
        ...
        Route::post('/fetch-contact-group', [ApiController::class, 'fetchContactAndGroup']);
        ...
        Route::match(['post', 'get'], '/info-device', [ApiController::class, 'infoDevices']);
        Route::post('/generate-qr', [ApiController::class, 'generateQr']);
    }
);
