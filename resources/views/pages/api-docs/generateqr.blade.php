<div class="tab-pane fade e" id="generateqr" role="tabpanel">
    ...
    <p>Endpoint: <code>{{ env('APP_URL') }}/api/generate-qr</code></p>
    
    <div class="alert alert-info">
        <h5><i class="bi bi-info-circle"></i> Important Notes:</h5>
        <ul class="mb-0">
            <li>Make sure WhatsApp Server is running at <code>{{ env('WA_URL_SERVER') }}</code></li>
            <li>Device should not be already connected</li>
            <li>Use <code>force=true</code> parameter to auto-create device if not exists</li>
        </ul>
    </div>
        ...
        <code class="json">
{
    ...
    <h4>Troubleshooting Common Errors:</h4>
    <div class="alert alert-warning">
        <h6><strong>"Failed to connect to WhatsApp server!"</strong></h6>
        <p class="mb-2">Check if WhatsApp Server is running:</p>
        <ul class="mb-0">
            <li>Make sure Node.js server is running at <code>{{ env('WA_URL_SERVER') }}</code></li>
    ...
    <div class="alert alert-danger">
        <h6><strong>"Invalid api key!"</strong></h6>
        <p class="mb-2">Solutions:</p>
        <ul class="mb-0">
            <li>Check your API key in User Settings</li>
            <li>Generate new API key if needed</li>
            <li>Ensure API key is included in request headers</li>
        </ul>
    </div>
    
    <div class="alert alert-info">
        <h6><strong>"Device not found!"</strong></h6>
        <p class="mb-2">Solutions:</p>
        <ul class="mb-0">
            <li>Add <code>"force": true</code> to auto-create device</li>
            <li>Or create device manually via Dashboard first</li>
        </ul>
    </div>
