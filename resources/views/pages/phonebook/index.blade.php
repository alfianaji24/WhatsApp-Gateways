<x-layout-dashboard title="Phone book">
    ...
    @if(!Session::has('selectedDevice') || !Session::get('selectedDevice')['device_id'])
        <div class="alert alert-warning alert-dismissible fade show" role="alert">
            <i class="bi bi-exclamation-triangle me-2"></i>
            <strong>Perhatian!</strong> Silakan pilih device terlebih dahulu dari dropdown "Select Device" di atas sebelum menggunakan fitur "Fetch From Selected Device".
        ...
        <div class="btn-group">
            ...
            @else
                <button type="button" class="btn btn-warning btn-sm text-white" disabled>
                    <i class="bi bi-exclamation-triangle"></i> Please Select Device First
                </button>
            @endif
